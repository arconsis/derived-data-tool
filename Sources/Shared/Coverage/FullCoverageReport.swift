...
// MARK: - FullCoverageReport

public struct FullCoverageReport: Coverage {
...
extension FullCoverageReport {
    /// Returns a new `CoverageReport` with the file paths modified to remove the given prefix.
    public func removingCommonPrefix(_ commonPrefix: String) -> FullCoverageReport {
        ...
        return FullCoverageReport(targets: updatedTargets)
    }
}
